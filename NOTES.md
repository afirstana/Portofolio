...
1. **Katalog Sertifikasi Terstandarisasi (`/learning/`)**:
...
2. **Katalog Opini & Esai Teknis Ultra-Minimalis (`/opinion/`)**:
...
3. **Perapian Bar Navigasi Utama (`components/SiteHeader.tsx`)**:
   ...
   - Menggunakan tipografi monospace seragam (`"Courier New"`, uppercase, `10px`, `letter-spacing: .12em`) di seluruh dropdown dan popover CV.

4. **Pembakuan Standar Desain & Dokumentasi**:
...
│
└── ACTIONS (Kanan)
    ├── CV ▼                 ➔ Direct Download Popover (EN & ID)
...
- **Vitest Unit & Integration**: **232 / 232 Tests Lulus (14 Suites)** dalam 4.34s.
