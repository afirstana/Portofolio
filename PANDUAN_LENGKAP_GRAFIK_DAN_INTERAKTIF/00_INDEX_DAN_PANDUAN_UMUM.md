...
[01. FINTECH & 3D ANTI-FRAUD] ➔ (#1 2D SQL Suite) ➔ (#3 3D Network Graph) ➔ (#5 3D Anomaly Manifold)
[02. EKONOMETRIKA & ENERGI]   ➔ (#2 3D Volatility Manifold) ➔ (#8 Brent Market Dynamics 2D)
[03. EPIDEMIOLOGI KESEHATAN]  ➔ (#4 Global Cancer Surveillance & Survival Elasticity)
[04. E-COMMERCE & LOGISTIK]   ➔ (#6 Olist Logistics) ➔ (#7 Olist Payment & RFM) ➔ (#9 Amazon NLP)
[05. REKAYASA SISTEM & ML]    ➔ (#10 ML Product Mapping) ➔ (#11 Revenue Reconciliation) ➔ (#12 Certificate App)
...
| **02** | [`02_BRENT_OIL_3D_VOLATILITY_MANIFOLD.md`](./02_BRENT_OIL_3D_VOLATILITY_MANIFOLD.md) | **Brent Oil 3D Volatility & Leptokurtic Crisis Manifold** | Kanvas 3D 36 Epoch × 19 Bin Return, 7 Tiang Laser Krisis |
| **03** | [`03_BANKING_FRAUD_3D_NETWORK_GRAPH.md`](./03_BANKING_FRAUD_3D_NETWORK_GRAPH.md) | **Banking 3D Force-Directed Financial Crime Graph** *(Dipindahkan ke #3)* | Graf 3D Coulomb-Hooke, Aliran Dana Laser, 3 Sindikat |
| **04** | [`04_GLOBAL_CANCER_EPIDEMIOLOGY.md`](./04_GLOBAL_CANCER_EPIDEMIOLOGY.md) | **Global Cancer Epidemiology & Survival Surveillance** | Scatter/Bubble 281k baris, 15 Survival Matrix, GDP Elasticity |
| **05** | [`05_BANKING_FRAUD_3D_ANOMALY_MANIFOLD.md`](./05_BANKING_FRAUD_3D_ANOMALY_MANIFOLD.md) | **Banking 3D Latent Feature Manifold & Hyperplane** *(Dipindahkan ke #5)* | Ruang Fitur $R^3$, 3D Decision Hyperplane $\mathcal{H}(\tau)$, Confusion Matrix |
| **06** | [`06_OLIST_LOGISTICS_ANALYSIS.md`](./06_OLIST_LOGISTICS_ANALYSIS.md) | **Olist E-Commerce Logistics & Delivery SLA** | Peta Latensi 27 Negara Bagian Brazil, Freight vs Delivery |
| **07** | [`07_OLIST_PAYMENT_BEHAVIOR.md`](./07_OLIST_PAYMENT_BEHAVIOR.md) | **Olist Payment Behavior & Installment Depth** | Payment Mix Donut, Cicilan vs AOV, Matriks RFM 4 Pilar |
| **08** | [`08_BRENT_OIL_MARKET_DYNAMICS.md`](./08_BRENT_OIL_MARKET_DYNAMICS.md) | **Brent Oil Market Dynamics & Geopolitical Econometrics** | Ekonometrika 35.5 Tahun, 7 Rezim Krisis, VaR 99% & ES |
| **09** | [`09_AMAZON_PRODUCT_INTELLIGENCE.md`](./09_AMAZON_PRODUCT_INTELLIGENCE.md) | **Amazon Product Review Intelligence & NLP Simulator** | Live NLP Sentiment Simulator, ML Benchmark ROC-AUC 0.8369 |
| **10** | [`10_ML_PRODUCT_MAPPING.md`](./10_ML_PRODUCT_MAPPING.md) | **Automated ML Product Taxonomy Mapping System** | Cosine Similarity Matrix, Kurva Precision-Recall Tradeoff |
| **11** | [`11_REVENUE_RECONCILIATION.md`](./11_REVENUE_RECONCILIATION.md) | **Multi-Tier Revenue Reconciliation & Variance Engine** | Diagram Waterfall 4 Tingkat, Audit Variance Inspector |
| **12** | [`12_CERTIFICATE_GENERATOR_APP.md`](./12_CERTIFICATE_GENERATOR_APP.md) | **Automated Certificate Engine & Layout Grid** | Grid Kalibrasi Tipografi, Batch Rendering, Hash Integrity |
